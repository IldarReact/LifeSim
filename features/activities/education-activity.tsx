            ...
            >
              <div className="space-y-4">
                ...
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Немецкий язык (Intensive)", 600, 20, "German", "6 месяцев")}
                />
              </div>
            </OpportunityCard>
            ...
            >
              <div className="space-y-4">
                ...
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Data Science и Аналитика", 1800, 30, "Data Science", "9 месяцев")}
                />
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Fullstack JavaScript", 1500, 30, "JS/React", "9 месяцев")}
                />
              </div>
            </OpportunityCard>
            ...
            >
              <div className="space-y-4">
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Digital Marketing", 900, 20, "Маркетинг", "6 месяцев")}
                />
              </div>
            </OpportunityCard>
            ...
            >
              <div className="space-y-4">
                ...
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Adobe Photoshop Pro", 500, 15, "Photoshop", "3 месяца")}
                />
              </div>
            </OpportunityCard>
            ...
            >
              <div className="space-y-4">
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Основы инвестирования", 300, 10, "Инвестиции", "3 месяца")}
                />
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Управление личными финансами", 200, 5, "Фин. грамотность", "3 месяца")}
                />
              </div>
            </OpportunityCard>
          </div>
