...
function ActiveEducationCard({ title, progress, total, energy }: { title: string, progress: number, total: number, energy: number }) {
...
export function EducationActivity(): React.JSX.Element | null {
  ...
  const handleCourseEnroll = (courseName: string, cost: number, energyCost: number, skillBonus: string, durationStr: string) => {
    ...
    const currentEnergyCost = activeCourses.reduce((acc, c) => acc + c.energyCostPerTurn, 0) +
      activeUniversity.reduce((acc, c) => acc + c.energyCostPerTurn, 0) +
      player.jobs.reduce((acc, j) => acc + j.energyCost, 0)

    if (100 - currentEnergyCost < energyCost) {
      setFeedback({ show: true, success: false, message: 'Недостаточно свободной энергии. Завершите другие дела.' })
      return
    }
    ...
    studyCourse(courseName, cost, energyCost, skillBonus, duration)
  ...
  const handleUniversityApply = (programName: string, cost: number, energyCost: number, skillBonus: string, durationStr: string) => {
    ...
    applyToUniversity(programName, cost, energyCost, skillBonus, duration)
        ...
        <div className="space-y-4">
          ...
          {!hasSkills ? (
            <div className="text-center py-8 bg-white/5 rounded-xl border border-white/10">
              <p className="text-white/50">У вас пока нет изученных навыков. Пройдите обучение, чтобы их получить.</p>
            </div>
          ) : (
            ...
            <div className="space-y-4">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 mb-4">
                <p className="text-sm text-blue-200">
                  ℹ️ Обучение в университете требует много времени и денег, но диплом значительно повышает шансы на высокооплачиваемую работу.
                </p>
              </div>
              ...
              <CourseCard
                ...
                onEnroll={() => handleUniversityApply("Бакалавриат: IT и Технологии", 5000, 30, "Программирование", "4 года")}
              />
              ...
              <CourseCard
                ...
                onEnroll={() => handleUniversityApply("Магистратура: Управление Бизнесом", 8000, 35, "Менеджмент", "2 года")}
              />
            </div>
          </OpportunityCard>
        </div>
            ...
            >
              <div className="space-y-4">
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Английский язык (Business)", 500, 15, "English", "3 месяца")}
                />
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Немецкий язык (Intensive)", 600, 20, "German", "4 месяца")}
                />
              </div>
            </OpportunityCard>
            ...
            >
              <div className="space-y-4">
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Python для Data Science", 1200, 25, "Python", "6 месяцев")}
                />
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Data Science и Аналитика", 1800, 30, "Data Science", "8 месяцев")}
                />
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Fullstack JavaScript", 1500, 30, "JS/React", "8 месяцев")}
                />
              </div>
            </OpportunityCard>
            ...
            >
              <div className="space-y-4">
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Digital Marketing", 900, 20, "Маркетинг", "4 месяца")}
                />
              </div>
            </OpportunityCard>
            ...
            >
              <div className="space-y-4">
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Graphic Design Basics", 700, 18, "Дизайн", "3 месяца")}
                />
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Adobe Photoshop Pro", 500, 15, "Photoshop", "2 месяца")}
                />
              </div>
            </OpportunityCard>
            ...
            >
              <div className="space-y-4">
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Основы инвестирования", 300, 10, "Инвестиции", "1 месяц")}
                />
                <CourseCard
                  ...
                  onEnroll={() => handleCourseEnroll("Управление личными финансами", 200, 5, "Фин. грамотность", "2 недели")}
                />
              </div>
            </OpportunityCard>
          </div>
