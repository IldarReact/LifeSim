...
const restActivities = [
  {
    ...
    energyCost: 10,
    effects: { happiness: 8, health: 3, sanity: 5 },
    cost: 0,
    icon: Mountain,
  ...
  },
  {
    ...
    energyCost: 30,
    effects: { health: 10, happiness: 5, sanity: -2 },
    cost: 1500,
    icon: Activity,
  ...
  },
  {
    ...
    title: "Медитация",
    energyCost: 15,
    effects: { sanity: 12, happiness: 6, intelligence: 3 },
    cost: 0,
    icon: Brain,
  ...
  },
  {
    ...
    title: "Чтение книги",
    energyCost: 10,
    effects: { intelligence: 8, happiness: 7, sanity: 4 },
    cost: 0,
    icon: Book,
    color: "text-blue-400",
  ...
  },
  {
    ...
    title: "Играть в игры",
    energyCost: 25,
    effects: { happiness: 12, sanity: -5, health: -2 },
    cost: 0,
    icon: Gamepad2,
    color: "text-cyan-400",
  ...
  },
  {
    ...
    title: "Рисование",
    energyCost: 20,
    effects: { happiness: 14, sanity: 10, intelligence: 4 },
    cost: 800,
    icon: Palette,
