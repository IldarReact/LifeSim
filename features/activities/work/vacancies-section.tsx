...
interface VacanciesSectionProps {
  onApply: (title: string, company: string, salary: string, requirements: Array<{ skill: string; level: number }>) => void
}
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-3">
          <VacancyDetailCard
            ...
            onApply={() => onApply("Junior Frontend", "StartUp Inc.", "$2,500/мес", [
              { skill: "Frontend", level: 1 },
              { skill: "JavaScript", level: 1 }
            ])}
          />
          ...
          <VacancyDetailCard
            ...
            onApply={() => onApply("Python Dev", "DataTech", "$4,500/мес", [
              { skill: "Python", level: 2 },
              { skill: "English", level: 2 }
            ])}
          />
          ...
          <VacancyDetailCard
            ...
            onApply={() => onApply("Data Analyst", "Analytics Corp", "$5,500/мес", [
              { skill: "Data Science", level: 2 },
              { skill: "Python", level: 2 }
            ])}
          />
          ...
          <VacancyDetailCard
            ...
            onApply={() => onApply("Marketing", "Brand Agency", "$3,800/мес", [
              { skill: "Маркетинг", level: 2 },
              { skill: "English", level: 2 }
            ])}
          />
          ...
          <VacancyDetailCard
            ...
            onApply={() => onApply("Designer", "Creative Studio", "$3,500/мес", [
              { skill: "Дизайн", level: 2 },
              { skill: "Photoshop", level: 1 }
            ])}
          />
          ...
          <VacancyDetailCard
            ...
            onApply={() => onApply("Senior Dev", "TechCorp", "$8,000/мес", [
              { skill: "Frontend", level: 4 },
              { skill: "English", level: 3 }
            ])}
          />
