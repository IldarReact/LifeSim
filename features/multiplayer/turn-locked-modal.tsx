      ...
      <DialogContent className="bg-linear-to-br from-amber-900/90 to-orange-900/90 border-amber-500/30 text-white max-w-md">
        ...
        <div className="space-y-4 py-4">
          ...
          <p className="text-white/70 text-sm">
            Пока все игроки не завершат ход, вы не можете вносить изменения в игру. Вы можете
            просматривать интерфейс, но все действия заблокированы.
          </p>

          <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
            <p className="text-sm text-amber-200">
              <strong>Подсказка:</strong> Если вы хотите отменить завершение хода и продолжить
              играть, закройте окно ожидания.
            </p>
          </div>
