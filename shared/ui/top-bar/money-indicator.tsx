    ...
    <div className="relative flex flex-col items-center">
      ...
      >
        <div className="flex items-center gap-1">
          ...
          <span className="text-lg font-bold text-white tabular-nums">{player.cash.toLocaleString()}</span>
        </div>
            ...
            <div className="text-xs text-white/90 space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center py-1.5 px-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                  ...
                  <span className="text-white/70 font-medium">+${player.quarterlyReport.income.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center py-1.5 px-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                  ...
                  <span className="text-white/70 font-medium">-${player.quarterlyReport.expenses.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center py-1.5 px-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                  <span className="text-rose-400 flex items-center gap-2">
                  ...
                  <span className="text-white/70 font-medium">-${player.quarterlyReport.taxes.toLocaleString()}</span>
                </div>
                <div className="border-t border-white/20 pt-2 mt-2">
                  <div className="flex justify-between items-center font-semibold py-1.5 px-2 rounded-lg bg-white/10">
                    ...
                    <span className={cn("text-sm", player.quarterlyReport.profit >= 0 ? "text-green-400" : "text-rose-400")}>
