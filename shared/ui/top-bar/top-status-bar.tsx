        ...
        <div className="relative flex items-center justify-between rounded-2xl border border-white/10 bg-zinc-950/80 px-4 py-2 shadow-2xl backdrop-blur-xl transition-all md:px-6">
          ...
          <div className="flex items-center gap-2">
            <div className="flex flex-col">
              <span className="text-xs font-medium text-white/50 uppercase tracking-wider">Страна</span>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col items-end">
              <span className="text-xs font-medium text-white/50 uppercase tracking-wider">Дата</span>
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button variant="ghost" size="icon" className="text-white/50 hover:text-rose-400 hover:bg-rose-500/10">
              ...
              <AlertDialogContent className="bg-black/90 border-white/10 backdrop-blur-xl">
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction onClick={resetGame} className="bg-rose-600 text-white hover:bg-rose-700 border-none">
                    Закончить
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
